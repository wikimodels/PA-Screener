...
export class MarketDataComponent implements OnInit {
  ...
  ngOnInit(): void {
    forkJoin({
      m15: this.marketDataService.getDataByTimeframe(TF.m15),
      h1: this.marketDataService.getDataByTimeframe(TF.h1),
      h4: this.marketDataService.getDataByTimeframe(TF.h4),
    })
      .pipe(
